...
<section class="full-width pageContent">
		<section class="full-width header-well">			
			<br/>
			<h3 class="text-center tittles" style="text-decoration: underline #0554B6 2px;">Bienvenid@ a su perfil como administrador.</h3>
		</section>
							<div>
							<form method ="post">
									<div>
							...
							<div class="mdl-card mdl-shadow--2dp full-width product-card">
								<div class="mdl-card__title">
									<img src="assets/img/pac0.png" alt="doc" class="img-responsive">
								</div>
