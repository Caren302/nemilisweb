    ...
    <div class="full-width panel-content">
							...
							<form method = "post">
									...
									<table class='mdl-data-table mdl-js-data-table mdl-shadow--2dp full-width table-responsive' style="width: 10%; padding">
											<thead><tr><th class='mdl-data-table__cell--non-numeric'>NSS:</th>
												<th>Nombre:</th>
												<th>Direccion:</th>
												<th>Telefono:</th>
												<th>Peso:</th>
								...
								<?php
									...
									try 
									{
										...
										$sentenciaSQL= "SELECT * FROM  recetamedico";
										foreach($conMySQL->query($sentenciaSQL) as $fila)
										{
											...
											<tr>
                                                ...
                                                <td>".$fila['medico']."</td>
												</td><td><input type='checkbox' id='cbox1' name='eliminar[]' value='".$fila['nss']."'></td>
												";
								...
								?>
									...
									<?php
										...
										if(empty($_POST['eliminar'])){
											...
											foreach($_POST['eliminar'] as $nss_borrar){
												$borrarAlumnos = $conexion->query("DELETE FROM recetamedica WHERE  id='$nss_borrar'");
											}
										}
										}
                ...
                <div> 
					<br>
					<br>
                <button class="boton" style="color: red" style="margin: 10px"  type="submit" value="Eliminar">Eliminar</button>            
		</div>
	</section>
</body>
</html>
