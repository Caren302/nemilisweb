				...
				<ul class="full-width list-unstyle menu-principal">
					...
					<li class="full-width">
						...
						<ul class="full-width menu-principal sub-menu-options">
							<li class="full-width">
								<a href="administardor.php" class="full-width">
									<div class="navLateral-body-cl">
					...
					<div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--8-col-desktop mdl-cell--2-offset-desktop">
						<div class="full-width panel mdl-shadow--2dp">
							...
							<div class="full-width panel-content">
								<form action="paci.php" method="post">
									<h5 class="text-condensedLight">Ingresa los datos solicitados</h5>
									<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
										<input class="mdl-textfield__input" type="number" pattern="-?[A-Za-záéíóúÁÉÍÓÚ ]*(\.[0-9]+)?" id="nss" name="nss" required>
										<label class="mdl-textfield__label" for="NameClient">NSS</label>
										<span class="mdl-textfield__error">NSS obligatorio</span>
									</div>
									<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									...
									<p class="text-center">
										<button class="mdl-button mdl-button--raised mdl-button--colored" style="WIDTH: 170px" id="btn-addClient"  onclick="Fagregartecins_inc_67()">Registrar Usuario
										</button>
									</p>
									<script>
										function Fagregartecins_inc_67(){
  
  if(confirm("¿Esta seguro de registrar este paciente?")){
