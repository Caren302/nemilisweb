							...
							<form method = "post">
								...
								<?php
									...
									try 
									{
										...
										$sentenciaSQL= "SELECT * FROM  pacientes";
										foreach($conMySQL->query($sentenciaSQL) as $fila)
										{
											...
											<tr>
												...
												<td>".$fila['correo']."</td>
												<td>".$fila['usuario']."</td>
												</td><td><input type='checkbox' nss='cbox1' name='eliminar[]' value='".$fila['nss']."'></td>
												";
								...
								if(isset($_POST['eliminar'])){
									if(empty($_POST['eliminar'])){
										...
										foreach($_POST['eliminar'] as $id_borrar){
											$borrarAlumnos = $conexion->query("DELETE FROM pacientes WHERE  id='$id_borrar'");
										}
									}
								}
