					...
					<div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--12-col-desktop">
							...
							<table  class="mdl-data-table mdl-js-data-table mdl-shadow--2dp full-width table-responsive">
								...
								<tr>
									...
									<td style="text-align: center;" >Temperatura Corporal	</td>
									<td style="text-align: center;">Sintomas</td>
								...
								<tr bgcolor="#FBFCFC">	
									...
									<td style="text-align: left;">Infeccion en la garganta</td>
									<td style="text-align: left;">Inyecciones Amoxcicilina</td>
								</tr>
							</table><br/>
						<center>
